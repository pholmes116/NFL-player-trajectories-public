...
tracking = (
    ...
    .with_columns([
        pl.when(pl.col("nflId").is_null()).then(0.0).otherwise(pl.col("dir_sin")).alias("dir_sin"),
        pl.when(pl.col("nflId").is_null()).then(0.0).otherwise(pl.col("dir_cos")).alias("dir_cos"),
    ])
